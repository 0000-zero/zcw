        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="${PATH}/admin/addAdmin" method="post" role="form">
                        <div style="color: chocolate">${errorMsg}</div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="userpswd" type="text" class="form-control" id="exampleInputPassword1" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
